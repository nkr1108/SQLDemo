...
CREATE INDEX salesRepEmployeeNumber_idx ON customers (salesRepEmployeeNumber);
...
-- CREATE INDEX reportsTo_idx ON employees (reportsTo);
-- CREATE INDEX officeCode_idx ON employees (officeCode);
...
-- CREATE INDEX productCode_idx ON orderdetails (productCode);
...
-- CREATE INDEX customerNumber_idx ON orders (customerNumber);
...
-- CREATE INDEX productLine_idx ON products (productLine);
